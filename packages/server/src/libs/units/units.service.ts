...
export class UnitsService {
  ...
  public async unitImages(): Promise<ImageResult> {
    ...
    const getWorkSheet = await this.googleService.getSheet(
      sheets,
      process.env.REPORT_SHEET,
      workSheet,
    );
