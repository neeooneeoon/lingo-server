...
export class PointService {
  ...
  public getBonusStreak(currentStreak: number): number {
    try {
      let bonusStreak = 0;
      if (currentStreak == 0) bonusStreak = 0;
      else if (currentStreak == 1) bonusStreak = 0.25;
      else if (currentStreak == 2) bonusStreak = 0.5;
      else if (currentStreak >= 3) bonusStreak = 1;
      else if (currentStreak <= 5) bonusStreak = 1.5;
      else if (currentStreak <= 10) bonusStreak = 2;
      else if (currentStreak <= 15) bonusStreak = 2.5;
      else if (currentStreak <= 20) bonusStreak = 2.75;
      else bonusStreak = 3;
      return bonusStreak;
    } catch (error) {
      throw new InternalServerErrorException(error);
