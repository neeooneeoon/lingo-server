import { QuestionRanking } from "@lingo/tools/src/generated/types";

export class GenerationConstants {
  public static DIGIT_REGEX = /[0-9]/g;

  public static ALPHABET_REGEX = /[a-z]/;

  public static GRADE_PATTERNS = {
    "1_2": [
  ...
  public static QUESTION_RANKS: QuestionRanking = {
    "3_5": {
      Word: {
        "2": 1,
        "3": 1,
