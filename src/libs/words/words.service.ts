...
export class WordsService {
    ...
    public async updateWords(ids: number | string[], unitNId: number): Promise<void> {
        try {
            let filter = {};
            let update = {};
