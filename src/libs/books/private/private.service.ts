...
export class BookPrivateService {
    ...
    public async getQuestionsInLevel(bookId: string, unitId: string, levelIndex: number): Promise<QuestionReducingOutput> {
        try {
